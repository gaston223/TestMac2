...
@section('content')
    ...
    <div class="container mt-5">
        <div class="col-md-12">
            <h2 class="mb-3">Vos informations personelles :</h2>
            ...
            <div class="card card-default mt-5">
                ...
                <div class="card-body">
                    <form action="{{route('users_update_form')}}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary">Je modifie mes infos</button>
                    </form>
                </div>
            </div>
        </div>
